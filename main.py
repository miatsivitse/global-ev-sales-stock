    ...
    dcc.Tabs([
        ...
        dcc.Tab(label='Unique Visuals', children=[
            ...
            html.Div([
                ...
                html.P("The ratio of EV stock to EV sales for the most recent year (2023) indicates how many EVs a country has on the road in comparison to how many they are selling."
                "For countries like Norway, this shows that they have a lot of EVS on the road already and the market may already becoming saturated for EVs. In comparison, a country such as Brazil, India,"
                "or Australia that has a lower ratio indicates that the country is selling a lot of EVs, but does not have many EVs already on the road as of the most recent year."
                "These countries could exemplify a desirable or up-and-coming market for EV sales."),
